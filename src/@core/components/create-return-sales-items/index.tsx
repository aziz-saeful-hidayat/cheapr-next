...
import { ReturnSalesItems } from 'src/@core/types'
...
interface CreateModalProps {
  columns: MRT_ColumnDef<ReturnSalesItems>[]
  onClose: () => void
  onSubmit: (values: ReturnSalesItems) => void
  open: boolean
  session: any
}
const CreateNewReturnSalesItems = ({ open, columns, onClose, onSubmit, session }: CreateModalProps) => {
  ...
  return (
    <Dialog open={open}>
      <DialogTitle textAlign='center'>Create New Sales Item Return</DialogTitle>
      <IconButton
        aria-label='close'
        onClick={onClose}
        sx={{
...
export default CreateNewReturnSalesItems
