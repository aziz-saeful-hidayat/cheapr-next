...
const CreateNewCity = ({ open, onClose, session }: CreateCityProps) => {
  const handleCreateCity = (values: City) => {
    console.log(values)
  ...
  const columnsNewCity = useMemo<MRT_ColumnDef<City>[]>(
    () => [
      {
        accessorKey: 'name',
        header: 'Name'
  ...
  const [values, setValues] = useState<any>(() =>
    columnsNewCity.reduce((acc, column) => {
