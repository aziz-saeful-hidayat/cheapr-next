          ...
          <Box sx={{ display: 'flex', gap: '1rem' }}>
            ...
            <Tooltip arrow placement='right' title='Delete'>
              <IconButton
                ...
                onClick={() => {
                  if (
                    !confirm(`Are you sure you want to delete this issue #${row.original?.selling?.channel_order_id}`)
                  ) {
                    return
                  }
...
const ReplacedReturnedLeads = (props: any) => (
  <QueryClientProvider client={queryClient}>
    <Example {...props} />
  </QueryClientProvider>
)

export default ReplacedReturnedLeads
