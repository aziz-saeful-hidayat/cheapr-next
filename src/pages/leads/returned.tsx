...
export const PurchaseDetailModal = ({ open, onClose, data }: PurchaseDetailModalProps) => {
  ...
  return (
    <Dialog open={open}>
      ...
      <Typography>P.O #, Date, Seller Name, Carrier Name, Tracking No, ETA</Typography>
      <DialogActions sx={{ p: '1.25rem' }}>
...
const Example = (props: any) => {
  ...
  const [pInfo, setpInfo] = useState<BuyingOrder>()
  ...
  return (
    <Card sx={{ padding: 3 }}>
      ...
      />
      <PurchaseDetailModal open={purchaseInfoModalOpen} onClose={() => setPurchaseInfoModalOpen(false)} data={pInfo} />
    </Card>
  )
}
